const texts = {
  fa: {
    ...
    withdrawAskAmount: 'مبلغ برداشت خود را به تومان وارد کنید (حداقل 100,000 تومان):', 
    withdrawMinError: 'حداقل مبلغ برداشت 100,000 تومان است. لطفاً دوباره وارد کنید:', 
    ...
    gameWin: '🎉🎉 تبریک، بردی!!\nمبلغ 100,000 تومان به موجودیت اضافه شد. می‌تونی همین الان برداشت بزنی 💸', 
